...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button partner  = (Button) findViewById(R.id.Partnerbtn);
        final Button map  = (Button) findViewById(R.id.mapbutton);
        final Button options  = (Button) findViewById(R.id.opbutton);

        partner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), PartnerSelection.class);
                startActivity(i);
            }
        });
